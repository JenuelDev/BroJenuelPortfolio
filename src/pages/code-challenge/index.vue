                            ...
                            <header>
                                <div class="item-top">
                                    <div class="item-folder">
                                        <v-icon size="46" v-if="code.headIcon" color="primary">{{code.headIcon}}</v-icon>
                                        <svg v-else viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg" width="40" height="40"><path d="M1.5 1A1.5 1.5 0 000 2.5v10A1.5 1.5 0 001.5 14h12a1.5 1.5 0 001.5-1.5v-8A1.5 1.5 0 0013.5 3H7.707l-2-2H1.5z" fill="currentColor"></path></svg>
                                    </div>
