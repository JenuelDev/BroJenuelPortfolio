import { mdiAngularjs, mdiFire, mdiLanguageHtml5, mdiLanguageJavascript, mdiLanguageRubyOnRails, mdiLaravel, mdiTabletCellphone, mdiVuejs } from '@mdi/js'
...
const info =
    ...
    "<p>Shortly after graduating from <a href='http://kcp.edu.ph/' rel='noreferrer' target='_blank'>Kings College of The Philippines</a>, I joined the team of software developers at a company where I work on a wide variety of fascinating technologies and helpful projects..</p>" +
